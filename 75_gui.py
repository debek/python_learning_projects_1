...
def edytujKontakt():
    ...
    nazwisko = kontakty[index].nazwisko
    telefon = kontakty[index].telefon
    email = kontakty[index].email
...
# button_dodajKontakt = Button(appRight, text="Dodaj kontakt", command=lambda: test(5))
